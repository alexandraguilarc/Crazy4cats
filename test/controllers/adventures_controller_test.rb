...
class AdventuresControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create adventure" do
    assert_difference("Adventure.count") do
      post adventures_url, params: { adventure: { country_id: @adventure.country_id, description: @adventure.description, title: @adventure.title, when_went: @adventure.when_went } }
    end
  ...
  test "should update adventure" do
    patch adventure_url(@adventure), params: { adventure: { country_id: @adventure.country_id, description: @adventure.description, title: @adventure.title, when_went: @adventure.when_went } }
